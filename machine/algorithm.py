...
test_data = pd.read_csv('./movie.csv') 
...
def sentiment_predict(new_sentence): 
  ...
  point = float(loaded_model.predict(pad_new)) 
  if(point > 0.5):
    print("\n{:.2f}% 확률로 긍정적 입니다.\n".format(point * 100),"\n{:.2f}% 확률로 부정적 입니다.\n".format(100 - (point * 100)))
    
  else:    
    print("\n{:.2f}% 확률로 부정적 입니다.\n".format((1 - point) * 100),"\n{:.2f}% 확률로 긍정적 입니다.\n".format(100 - ((1 - point) * 100)))
